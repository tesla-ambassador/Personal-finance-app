...
import { sumOfBudgetCategory } from "./some-of-specific-items";
...
test("Returns total expenditure for a given category", () => {
  expect(sumOfBudgetCategory(transactions, "Entertainment")).toBe(-25);
});

test("Returns total expenditure for a given category", () => {
  expect(sumOfBudgetCategory(transactions, "Dining Out")).toBe(-306.75);
});
